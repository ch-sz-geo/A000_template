...
Die Datei `+Stammdaten.xtf+` enthält die Stammdaten. Änderungen an dieser Datei werden über GitHub versioniert und mit einer eindeutigen Identifikationsnummer (Commit-Hash-ID) versehen. Mithilfe dieser ID können frühere Dateiversionen abgerufen werden.
